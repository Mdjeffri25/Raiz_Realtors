...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Greeting */}
      <div>
        <div className="text-xs tracking-widest text-raiz-secondary uppercase mb-1">
          {today}
        </div>
          ...
          {LEAD_STAGES.map((stage) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-2xl font-semibold text-raiz-black">
                  {count}
                </div>
              ...
              {followUps.slice(0, 6).map((fu, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm font-medium text-raiz-black truncate">
                      {fu.leadName || fu.name}
                    </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <div className="text-sm font-medium text-raiz-black">
                        {proj.name}
                      </div>
              ...
              <table className="w-full text-sm">
                ...
                <thead>
                  <tr className="border-b border-raiz-border">
                    ...
                    <th className="text-left text-10 font-semibold tracking-wide text-raiz-secondary uppercase py-2 pr-3">
                      Lead
                    </th>
                    ...
                    <th className="text-right text-10 font-semibold tracking-wide text-raiz-secondary uppercase py-2 pr-3">
                      Amount
                    </th>

                    <th className="text-left text-10 font-semibold tracking-wide text-raiz-secondary uppercase py-2">
                      Date
                    </th>
                ...
                <tbody className="divide-y divide-raiz-border">
                  ...
                  {bookings.slice(0, 6).map((b, i) => (
                    <tr
                      key={i}
                      className="hover:bg-raiz-offwhite/50 transition-colors"
                    >
                      ...
                      <td className="py-2.5 text-raiz-secondary">
  ...
  return (
    <div className="bg-white p-4 flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-10 font-medium tracking-wide text-raiz-secondary uppercase">
          {label}
        </span>
  ...
  return (
    <div className="rounded-lg border border-raiz-border bg-white p-5">
      ...
      <div className="mb-4">
        ...
        <h3 className="text-sm font-semibold text-raiz-black uppercase tracking-wide">
          {title}
        </h3>

        {description && (
          <p className="text-xs text-raiz-secondary mt-0.5">
            {description}
          </p>
        )}
...
function InlineEmpty({ text }) {
  return (
    <p className="text-sm text-raiz-secondary py-4 text-center">
      {text}
    </p>
  );
}